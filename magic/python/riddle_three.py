...
#riddle 3
riddle3 = """kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
"""
# groups = re.search(pattern, riddle3, )
all_found = re.findall(r'[a-z][A-Z][A-Z][A-Z]([a-z])[A-Z][A-Z][A-Z][a-z]', riddle3)
answer = ''
if all_found:
    for a in all_found:
        answer += a
